...
// Pano2VR 4.5.1/10655
// Filename: defaultskin.ggsk
// Generated Tue Feb 3 22:36:20 2015
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._svg_1__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 470px;height: 50px;-webkit-user-drag:none;');
		...
		this._movemode__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;-webkit-user-drag:none;');
		...
		this._container_1.appendChild(this._movemode);
		this._defaultview=document.createElement('div');
		this._defaultview.ggId="defaultview";
		this._defaultview.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		this._defaultview.ggVisible=true;
		this._defaultview.className='ggskin ggskin_svg';
		this._defaultview.ggType='svg';
		this._defaultview.ggUpdatePosition=function() {
			this.style[domTransition]='none';
			if (this.parentNode) {
				w=this.parentNode.offsetWidth;
				this.style.left=(-110 + w) + 'px';
				h=this.parentNode.offsetHeight;
				this.style.top=(-50 + h) + 'px';
			}
		}
		...
		hs+='visibility: inherit;';
		hs+='cursor: pointer;';
		this._defaultview.setAttribute('style',hs);
		this._defaultview__img=document.createElement('img');
		this._defaultview__img.className='ggskin ggskin_svg';
		this._defaultview__img.setAttribute('src',basePath + 'images/defaultview.svg');
		this._defaultview__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;-webkit-user-drag:none;');
		this._defaultview__img['ondragstart']=function() { return false; };
		this._defaultview.appendChild(this._defaultview__img);
		this._defaultview.onclick=function () {
			me.player.moveToDefaultView(0);
		}
		this._defaultview.onmouseover=function () {
			me._defaultview__img.src=basePath + 'images/defaultview__o.svg';
		}
		this._defaultview.onmouseout=function () {
			me._defaultview__img.src=basePath + 'images/defaultview.svg';
		}
		this._container_1.appendChild(this._defaultview);
		...
		this._autorotate__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;-webkit-user-drag:none;');
		...
		this._zoomout__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;-webkit-user-drag:none;');
		...
		this._zoomin__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;-webkit-user-drag:none;');
		...
		this._right__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;-webkit-user-drag:none;');
		...
		this._down__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;-webkit-user-drag:none;');
		...
		this._up__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;-webkit-user-drag:none;');
		...
		this._left__img.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 50px;height: 50px;-webkit-user-drag:none;');
