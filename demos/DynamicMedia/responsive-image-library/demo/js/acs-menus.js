...
$(".acs-market-menu").closest(".custom-dropdown-outer").find(".custom-dropdown").on("click", function () {
	...
	if ($(this).closest("form").find(".acs-market-menu").val() === 'iPhone 15 Pro') {
		$("#frame1").animate({"width":"430px","height":"932px","animation-duration":"1s"});
        $('#frame1').attr('scrolling', 'no');
		return false;
	}
	if ($(this).closest("form").find(".acs-market-menu").val() === 'iPad 13 Portrait') {
		$("#frame1").animate({"width":"1024px","height":"1366px","animation-duration":"1s"});
        $('#frame1').attr('scrolling', 'no');
		return false;
	}
	if ($(this).closest("form").find(".acs-market-menu").val() === 'iPad 13 Landscape') {
		$("#frame1").animate({"width":"1366px","height":"1224px","animation-duration":"1s"});
        $('#frame1').attr('scrolling', 'no');
		return false;
	}
...
// directs to specific pages
$(".acs-demo-menu").closest(".custom-dropdown-outer").find(".custom-dropdown").on("click", function () {
	// changes the form"s action link on specific choices
	if ($(this).closest("form").find(".acs-demo-menu").val() === 'Smart Crop') {
        $('#frame1').attr('src', '../index-smart-crop.html');
		return false;
	}
	if ($(this).closest("form").find(".acs-demo-menu").val() === 'Image Presets') {
        $('#frame1').attr('src', '../index-image-preset.html');
		return false;
	}
	if ($(this).closest("form").find(".acs-demo-menu").val() === 'Templates') {
        $('#frame1').attr('src', '../index-template.html');
		return false;
	}
});
