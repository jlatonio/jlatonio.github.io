...
$('.store-save').on('click', function() {
    $(this).closest('form').find('input[type="text"],textarea').css({"background": ""});
    ...
    // save animation
    $('.notes-btn-each').show();
    $(this).closest('.notes-container').find(".notes-btn-each").removeClass('notes-btn-each-empty').addClass('notes-btn-each-active');
    setTimeout(function() {
