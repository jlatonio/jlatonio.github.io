...
$(document.body).on("click", ".custom-dropdown-slots .custom-dropdown", function () {
    ...
    if ($(this).closest(".column-container-notes").find(".store-data").val().indexOf("Genuine") > -1) {
        $(".draft-value").val("Genuine").css({
            "background-color": ""
        });
        $(".draft-value").closest(".column-container-notes").find(".custom-dropdown").removeClass("active").css({
            "background-color": "",
            "color": ""
        });
    ...
    if ($(this).closest(".column-container-notes").find(".store-data").val().indexOf("Innovative") > -1) {
        $(".draft-value").val("Innovative").css({
            "background-color": ""
        });
        $(".draft-value").closest(".column-container-notes").find(".custom-dropdown").removeClass("active").css({
            "background-color": "",
    ...
    if ($(this).closest(".column-container-notes").find(".store-data").val().indexOf("Exceptional") > -1) {
        $(".draft-value").val("Exceptional").css({
            "background-color": ""
        });
        $(".draft-value").closest(".column-container-notes").find(".custom-dropdown").removeClass("active").css({
            "background-color": "",
...
$(document.body).on("click", ".custom-dropdown-delete", function () {
    "use strict";
    $(this).closest(".column-container-notes").find("input[type=text]").val("").css({
        "background": ""
    });
    $(this).closest(".column-container-notes").find("textarea").val("").css({
        "background": ""
...
// clears content for open draft
$(".store-reset").on("click", function () {
    "use strict";
    $(".custom-dropdown-close").trigger("click");
    $(".custom-dropdown-large .custom-dropdown").removeClass("active");
    var textarea_place_holder = $("textarea").attr("data-placeholder");
