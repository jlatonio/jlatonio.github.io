...
$(".testp,.guide-each").on("click", function() {
	...
	var inspect_preset = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + select_preset + "$";
	var inspect_image = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$";
...
$(".store-continue").on("click", function() {
	"use strict";
	var assetprev1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier1").text() + "$" + $(".asset-specs-add1").val();
	var assetprev2 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier2").text() + "$" + $(".asset-specs-add2").val();
	var assetprev3 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier3").text() + "$" + $(".asset-specs-add3").val();
	var assetprev4 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier4").text() + "$" + $(".asset-specs-add4").val();
	var assetprev5 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier5").text() + "$" + $(".asset-specs-add5").val();
	var assetprevd1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier-d1").text() + "$" + $(".asset-specs-add-d1").val();
	var assetprevm1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier-m1").text() + "$" + $(".asset-specs-add-m1").val();
...
$("#inner-guides-checked").click(function() {
	...
	$("#inner-guides-unchecked").show();
	$("#inner-guides-checked").hide();
	var assetprev1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier1").text() + "$";
	var assetprev2 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier2").text() + "$";
	var assetprev3 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier3").text() + "$";
	var assetprev4 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier4").text() + "$";
	var assetprev5 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier5").text() + "$";
	var assetprevd1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier-d1").text() + "$";
	var assetprevm1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier-m1").text() + "$";
	$(".testurl_preview1").attr('src', assetprev1);
	$(".testurl_preview2").attr('src', assetprev2);
	$(".testurl_preview3").attr('src', assetprev3);
	$(".testurl_preview4").attr('src', assetprev4);
...
$("#inner-guides-unchecked").click(function() {
	...
	var assetprev1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier1").text() + "$" + "&fmt=jpg&bgc=000000";
	var assetprev2 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier2").text() + "$" + "&fmt=jpg&bgc=000000";
	var assetprev3 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier3").text() + "$" + "&fmt=jpg&bgc=000000";
	var assetprev4 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier4").text() + "$" + "&fmt=jpg&bgc=000000";
	var assetprev5 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier5").text() + "$" + "&fmt=jpg&bgc=000000";
	var assetprevd1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier-d1").text() + "$" + "&fmt=jpg&bgc=000000";
	var assetprevm1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier-m1").text() + "$" + "&fmt=jpg&bgc=000000";
	$(".testurl_preview1").attr('src', assetprev1);
	$(".testurl_preview2").attr('src', assetprev2);
	$(".testurl_preview3").attr('src', assetprev3);
	$(".testurl_preview4").attr('src', assetprev4);
...
$("#alpha-guides-unchecked").click(function() {
	...
	var assetprev1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier1").text() + "$" + "&fmt=png-alpha";
	var assetprev2 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier2").text() + "$" + "&fmt=png-alpha";
	var assetprev3 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier3").text() + "$" + "&fmt=png-alpha";
	var assetprev4 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier4").text() + "$" + "&fmt=png-alpha";
	var assetprev5 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier5").text() + "$" + "&fmt=png-alpha";
	var assetprevd1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier-d1").text() + "$" + "&fmt=png-alpha";
	var assetprevm1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?$" + $(".modifier-m1").text() + "$" + "&fmt=png-alpha";
	$(".testurl_preview1").attr('src', assetprev1);
	$(".testurl_preview2").attr('src', assetprev2);
	$(".testurl_preview3").attr('src', assetprev3);
	$(".testurl_preview4").attr('src', assetprev4);
...
$("#original-guides-unchecked").click(function() {
	...
	var assetprev1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?&scl=1&fmt=jpg";
	var assetprev2 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?&scl=1&fmt=jpg";
	var assetprev3 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?&scl=1&fmt=jpg";
	var assetprev4 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?&scl=1&fmt=jpg";
	var assetprev5 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?&scl=1&fmt=jpg";
	var assetprevd1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?&scl=1&fmt=jpg";
	var assetprevm1 = "https://s7test1.scene7.com//is/image/verizonqa/" + $(".s7asset").val() + "?&scl=1&fmt=jpg";
	$(".testurl_preview1").attr('src', assetprev1);
	$(".testurl_preview2").attr('src', assetprev2);
	$(".testurl_preview3").attr('src', assetprev3);
	$(".testurl_preview4").attr('src', assetprev4);
